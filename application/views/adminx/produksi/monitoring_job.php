                              ...
                              <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                <thead>
                                  <tr class="">
                                    ...
                                    <th class="text-center bg-primary">Tanggal Turun Job</th>
                                    ...
                                    <th class="text-center bg-primary">Total Job</th>
                                    <th class="text-center bg-primary">Sisa Job</th>
                                    <th class="text-center bg-primary">Lokasi WH</th>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#order-table').DataTable({
        ...
        'serverMethod': 'POST',
        'ajax': {
          url: "<?php echo base_url(); ?>produksi_report/monitoring_job_list",
          type: 'POST',
          "data": function(data) {
        ...
        'aoColumns': [{
          ...
          {
            "Tanggal Turun Job": "Tanggal Turun Job",
            "sClass": "text-center"
          },
          {
            "Part ID": "Part ID",
