  ...
  <body>
           ...
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="modal-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" id="nama_kategori" name="nama_kategori" class="form-control" required="required">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/sweetalert2.all.min.js"></script>
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo site_url('project/project_kategori_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              if (data.status == 'forbidden'){
                ...
                $('[name="kode"]').val(data.id_kategori);
      ...
      function openModalDelete(id) {
      	Swal.fire({
				  ...
				  if (result.isConfirmed) {
				    $.ajax({
              url: '<?php echo site_url('project/project_kategori_hapus') ?>/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo site_url('project/project_kategori_add')?>";
        } else {
          url = "<?php echo site_url('project/project_kategori_update')?>";
        }
	    ...
	    $(document).ready(function() {
	      ...
	      table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>project/project_kategori_list",
              "type": "POST",
            },
            ...
            "aoColumns": [
              ...
              { "Nama Kategori": "Nama Kategori" , "sClass": "text-left" },
