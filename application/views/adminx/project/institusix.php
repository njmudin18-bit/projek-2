  ...
  <body>
           ...
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="modal-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" id="nama_institusi" name="nama_institusi" class="form-control" required="required">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea id="alamat_institusi" name="alamat_institusi" class="form-control" required="required" rows="5"></textarea>
                  <span class="help-block"></span>
                </div>
              </div>
           	</form>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/sweetalert2.all.min.js"></script>
      ...
      function openModal() {
        ...
        $('.modal-title').text('Tambah Institusi'); // Set Title to Bootstrap modal title
      }

      function closeModal(){
        $('#RegisterValidation')[0].reset();
        $('#modal').modal('hide');
        $('.modal-title').text('Tambah Institusi');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo site_url('project/project_institusi_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              if (data.status == 'forbidden'){
                ...
                $('[name="kode"]').val(data.id_institusi);
                $('[name="nama_institusi"]').val(data.nama);
                $('[name="alamat_institusi"]').val(data.alamat);
                $('#modal').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit Institusi'); // Set title to Bootstrap modal title
      ...
      function openModalDelete(id) {
      	Swal.fire({
				  ...
				  if (result.isConfirmed) {
				    $.ajax({
              url: '<?php echo site_url('project/project_institusi_hapus') ?>/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo site_url('project/project_institusi_add')?>";
        } else {
          url = "<?php echo site_url('project/project_institusi_update')?>";
        }
	    ...
	    $(document).ready(function() {
	      ...
	      table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>project/project_institusi_list",
              "type": "POST",
            },
            ...
            "aoColumns": [
              ...
              { "Nama Institusi": "Nama Institusi" , "sClass": "text-left" },
	      ...
	      $("#nama_institusi").change(function(){
          $(this).parent().removeClass('has-error');
          $(this).next().empty();
        });

        $("#alamat_institusi").change(function(){
          $(this).parent().removeClass('has-error');
          $(this).next().empty();
        });
	    });
