...
<!-- <link rel="stylesheet" type="text/css" href="<?php //echo base_url(); ?>files/bower_components/fullcalendar/css/fullcalendar.css"> -->
<!-- <link rel="stylesheet" type="text/css" href="<?php //echo base_url(); ?>files/bower_components/fullcalendar/css/fullcalendar.print.css" media='print'> -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>files/assets/css/calendar_v1.css">
