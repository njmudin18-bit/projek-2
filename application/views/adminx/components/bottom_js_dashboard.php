...
<script src="<?php echo base_url(); ?>files/assets/pages/chart/float/jquery.flot.js"></script>
<script src="<?php echo base_url(); ?>files/assets/pages/chart/float/jquery.flot.categories.js"></script>
<script src="<?php echo base_url(); ?>files/assets/pages/chart/float/curvedLines.js"></script>
<script src="<?php echo base_url(); ?>files/assets/pages/chart/float/jquery.flot.tooltip.min.js"></script>

<script src="<?php echo base_url(); ?>files/bower_components/chartist/js/chartist.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>files/assets/pages/dashboard/custom-dashboard.min.js"></script>
