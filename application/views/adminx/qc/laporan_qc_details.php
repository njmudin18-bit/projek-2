...
<body>
                              ...
                              <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                <thead>
                                  <tr class="">
                                    ...
                                    <th class="text-center bg-primary">History Reject</th>
                                  </tr>
                                </thead>
                                <tbody></tbody>
                                <tfoot>
  ...
  <script type="text/javascript">
    ...
    function open_details_reject(scan_id) {
      console.log(scan_id);
      $.ajax({
    ...
    $(document).ready(function() {
      table = $('#order-table').DataTable({
        ...
        'serverMethod': 'POST',
        'ajax': {
          url: "<?php echo base_url(); ?>qc_report/monitoring_job_details_list",
          type: 'POST',
          "data": function(data) {
