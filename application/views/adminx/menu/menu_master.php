  ...
  <body>
    ...
    <div id="pcoded" class="pcoded">
						                    ...
						                    <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
						                      <thead class="bg-primary text-center">
						                       	<tr>
							                        ...
							                        <!-- <th class="text-center" width="5%">Menu ID</th> -->
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>menu/menu_edit/" + id,
            type: "GET",
            dataType: "JSON",
      ...
      function openModalDelete(id) {
      	Swal.fire({
				  ...
				  if (result.isConfirmed) {
				    $.ajax({
              url: '<?php echo base_url(); ?>menu/menu_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo base_url(); ?>menu/menu_add";
        } else {
