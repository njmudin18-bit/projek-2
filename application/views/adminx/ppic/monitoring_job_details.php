      ...
      $(document).ready(function() {
        table = $('#order-table').DataTable( {
            ...
            'aoColumns': [
              ...
              { "Prod Time Scanned": "Prod Time Scanned" , "sClass": "text-center" },
              { "Prod Scanned by": "Prod Scanned by" , "sClass": "text-center" },
              { "QC Scan Loc": "QC Scan Loc" , "sClass": "text-center" },
              { "QC Time Scanned": "QC Time Scanned", "sClass": "text-center" },
              { "QC Scanned by": "QC Scanned by" , "sClass": "text-center" },
