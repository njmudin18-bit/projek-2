           ...
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="modal-body">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Permissions Group</label>
                <div class="col-sm-10">
                  <select id="idpermissions_group" name="idpermissions_group" class="form-control">
        ...
        $.ajax({
            ...
            success: function(data)
            {
              if (data.status == 'forbidden'){
                ...
                $('.modal-title').text('Edit Permissions'); // Set title to Bootstrap modal title
