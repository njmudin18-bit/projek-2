  ...
  <body>
           ...
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="modal-body">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Roles Name</label>
                <div class="col-sm-10">
                  <input type="text" id="roles_name" name="roles_name" class="form-control" required="required">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/sweetalert2.all.min.js"></script>
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>roles/roles_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              if (data.status == 'forbidden'){
                ...
                $('[name="kode"]').val(data.idroles);
                $('[name="roles_name"]').val(data.roles_name);
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo base_url(); ?>roles/roles_add";
        } else {
          url = "<?php echo base_url(); ?>roles/roles_update";
        }
	    ...
	    $(document).ready(function() {
	      ...
	      table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>roles/roles_list",
              "type": "POST",
            },
            ...
            "aoColumns": [
              ...
              { "#": "#" , "sClass": "text-center" },
              { "Roles Name": "Roles Name" , "sClass": "text-left" },
              { "Status": "Status" , "sClass": "text-center" },
              { "Matrix": "Matrix" , "sClass": "text-center" }
            ],
