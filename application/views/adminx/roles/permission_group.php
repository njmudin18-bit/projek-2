  ...
  <body>
						                    ...
						                    <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
						                      <thead class="bg-primary text-center">
						                       	<tr>
							                        ...
							                        <th class="text-center">Permissions Group Name</th>
           ...
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="modal-body">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Permissions Group Name</label>
                <div class="col-sm-10">
                  <input type="text" id="permissions_groupname" name="permissions_groupname" class="form-control" required="required">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Display Icon</label>
                <div class="col-sm-10">
                  <input type="text" id="display_icon" name="display_icon" class="form-control" required="required">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>files/assets/js/sweetalert2.all.min.js"></script>
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>permissiongroup/permissiongroup_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              if (data.status == 'forbidden'){
                ...
                $('[name="kode"]').val(data.idpermissions_group);
                $('[name="permissions_groupname"]').val(data.permissions_groupname);
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo base_url(); ?>permissiongroup/permissiongroup_add";
        } else {
          url = "<?php echo base_url(); ?>permissiongroup/permissiongroup_update";
        }
	    ...
	    $(document).ready(function() {
	      ...
	      table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>permissiongroup/permissiongroup_list",
              "type": "POST",
            },
            ...
            "aoColumns": [
              ...
              { "#": "#" , "sClass": "text-center" },
              { "Permissions Group Name": "Permissions Group Name" , "sClass": "text-left" },
              { "Icon": "Icon" , "sClass": "text-center" },
        ...
        $("#permissions_groupname").change(function(){
